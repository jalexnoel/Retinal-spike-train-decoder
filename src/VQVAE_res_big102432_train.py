...
def main():
    ...
    writer = SummaryWriter("../logs/celebaMask/log_VQVAE_res_big102432")
    ...
    myTestDataset = SpikeDataset1(img_path="../dataset/celebaMask", transforms=my_transforms, data_type='valid')
