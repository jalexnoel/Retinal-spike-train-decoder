...
def main():
    ...
    writer = SummaryWriter("../logs/cifar10/log_VQVAE_res_big102432")
    ...
    myDataset = SpikeDataset1(img_path="../dataset/cifar10", transforms=my_transforms)
    myDataloader = DataLoader(dataset=myDataset, batch_size=256, shuffle=True)

    myTestDataset = SpikeDataset1(img_path="../dataset/cifar10", transforms=my_transforms, data_type='valid')
