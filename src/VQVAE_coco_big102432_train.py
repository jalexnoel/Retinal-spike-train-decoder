...
def main():
    ...
    myDataset = SpikeDataset1(img_path="../dataset/coco", transforms=my_transforms)
    myDataloader = DataLoader(dataset=myDataset, batch_size=256, shuffle=True)

    myTestDataset = SpikeDataset1(img_path="../dataset/coco", transforms=my_transforms, data_type='valid')
